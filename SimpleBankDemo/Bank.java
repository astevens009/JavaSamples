...
public class Bank {
    ...
    public Branch createBranch(String name, String region){
        ...
        // variable
        // TODO: Create method to check that the branch hasn't already been created
    ...
    public void processCustomerTransaction(){
        ...
        // Display the list of bank branches
        ...
        // List the customers for the branch
        ...
        // List the transactions to perform
        ...
        // Display customer's current balance after the transaction
